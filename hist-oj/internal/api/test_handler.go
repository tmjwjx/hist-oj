...
func (h *Handler) TestInsertOperationLog(c *gin.Context) {
	...
	h.ratingService.LogOperation("admin", "admin", "personal_adjust", "user", "testuser", `{"username":"testuser","oldRating":1200,"newRating":1210,"ratingChange":10,"reason":"测试：手动调整Rating"}`, "127.0.0.1")
